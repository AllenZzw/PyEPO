...
def genData(num_data, num_features, num_customers, max_demand=10, deg=1, noise_width=0, seed=135):
    """
    ...
    Args:
        ...
        max_demand (float): maximum demand of customers 
    ...
    # customer demands 
    demands = rnd.uniform(low=1, high=max_demand, size=num_customers)
    # init cost
